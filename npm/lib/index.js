...
function (_React$Component) {
  ...
  function Modalfy(props) {
    ...
    _this.mounted = _this.props.mounted ? _this.props.mounted.bind(_assertThisInitialized(_assertThisInitialized(_this))) : _this.mounted.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.updated = _this.props.updated ? _this.props.updated.bind(_assertThisInitialized(_assertThisInitialized(_this))) : _this.updated.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.unmounted = _this.props.unmounted ? _this.props.unmounted.bind(_assertThisInitialized(_assertThisInitialized(_this))) : _this.unmounted.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
